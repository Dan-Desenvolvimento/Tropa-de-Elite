-- Recreates the tracking tables if migration 0015 was recorded remotely
-- without the objects being available to PostgREST.
...
-- Ask PostgREST to refresh its schema cache immediately after the repair.
